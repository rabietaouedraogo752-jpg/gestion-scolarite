...
<div class="container py-4">
    ...
    <form method="post" action="{{ route('gestion.creer_enseignant.store') }}">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="domaine_enseignement" class="form-control" value="{{ old('domaine_enseignement', $prefill['domaine_enseignement'] ?? request('domaine_enseignement')) }}" placeholder="Ex: Bases de données, Réseaux, Mathématiques">
        </div>
        <div class="row">
