        ...
        <div class="col-md-9 col-lg-10 p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted small">Bienvenue sur votre espace de gestion pédagogique</p>
                </div>
                <div class="badge bg-primary p-2 fs-6 shadow-sm">Agent de Scolarité</div>
            </div>
            ...
            <!-- Section d'Affichage des Données (Exemple : Dernières inscriptions) -->
